...
?>
        ...
        <a class="warna4 panel" href="<?php echo make_permalink("?app=".app_param('app')."&view=".app_param('view')."&type=".app_param('type')."&cat=".app_param('cat')); ?>"> 
        Kembali
            </a> 
			...
			<table class="" style="width:100%"><tr>
				...
				<tr>
					...
					<td style="width: 70%"><br><br>
						<button class='btn btn-success right'>Kirim Pengajuan</button>
					</td>	
				</tr>
