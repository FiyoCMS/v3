		...
		<div id="article">
			...
			<div class="article-list">	
				<?php if($article->content->image[$i]) : ?>
					<img src="<?php echo $article->content->image[$i]; ?>" alt="<?php echo $title[$i]; ?>" class="image-intro" style="max-width:100px; max-height:80px; float: left;" width="<?php echo $article->imgW;?>" />
				<?php endif; ?>
