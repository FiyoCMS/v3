		...
		<div id="article">
			...
			<div class="article-box">	
				...
				<div class="article-blog">
					...
					<img src="<?php echo $article->content->image[$i]; ?>" alt="<?php echo $article->content->title[$i]; ?>" class="image-intro" style="max-width:<?php echo $article->imgW;?>px; max-height:<?php echo $article->param->imgH; ?>px" width="<?php echo $article->imgW;?>" />
					<?php endif; ?>
