...
<form id="mapForm">
<div id="mapLegend">
    <h3>INFORMASI <br>TANAH LONGSOR </h3>
...
<div id="map" style="height: 400px"></div>
	...
	<script>
        ...
        function loadMap(ff) {
            ...
            return L.geoJson(data_bencana_<?php echo app_param('view'); ?>, {
                style: function (feature) {
                    ...
                    if (feature.properties.Klas_TL == "Sedang") {
                        ini = {                    
                            color: '#fbc531',
                            fillOpacity: 0.5,
                            dashArray: '2',
                        }
                    } else if (feature.properties.Klas_TL == "Tinggi") {
                        ini = {                    
                            color: '#e17055',
                            fillOpacity: 0.5,
                            dashArray: '2',
                ...
                filter: (feature) =>  {                    
                    ...
                    const kelasCon = f['kelas'].includes(feature.properties.Klas_TL);
		...
		function onEachFeature(feature, layer) {
            ...
            + "<tr><td>Kelas Bencana </td><td>: "+ feature.properties.Klas_TL + "</td></tr>"
