...
<div id="mapLegend">
    ...
    <li>
    <div> 
    <?php echo Form::checkbox("data_bangunan","","1",["target" => "bangunan[]"],"Data Bangunan"); ?>
...
<div id="map" style="height: 400px"></div>
    ...
    <script src="<?php echo FUrl;?>?app=geomap&api=bangunan&type=banjir"></script>
	...
	<script>
        ...
        function loadMap2(ff) {
            ...
            //console.log(f);
            return L.geoJson(data_bangunan_banjir, {
                style: function (feature) {
                    ini = {};
