...
<div id="map" style="height: 400px"></div>
	...
	<script>
        ...
        function loadMap(ff) {
            ...
            return L.geoJson(data_bencana_<?php echo app_param('view'); ?>, {
                style: function (feature) {
                    ...
                    if (feature.properties.Kelas_Bhy == "Sedang") {
                        ini = {                    
                            color: '#fbc531',
                            fillOpacity: 0.5,
                            dashArray: '2',
                        }
                    } else if (feature.properties.Kelas_Bhy == "Tinggi") {
                        ini = {                    
                            color: '#e17055',
                            fillOpacity: 0.5,
                            dashArray: '2',
                ...
                filter: (feature) =>  {                    
                    ...
                    const kelasCon = f['kelas'].includes(feature.properties.Kelas_Bhy);
                    const area = f['area'].includes(feature.properties.TGL);
		...
		function onEachFeature(feature, layer) {
            ...
            + "<tr><td>Kelas Bencana </td><td>: "+ feature.properties.Kelas_Bhy + "</td></tr>"
            + "<tr><td>Jenis Area Bencana </td><td>: "+ feature.properties.TGL + "</td></tr>"
