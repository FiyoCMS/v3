...
<head>
	...
	<!-- autoload Script before body -->
	<script src="<?php echo AdminPath; ?>/js/jquery.min.js"></script>
	<script src="<?php echo AdminPath; ?>/js/jquery-ui.min.js"></script>
	<?php if(checkMobile()) : ?>	
	...
	<script src="<?php echo AdminPath; ?>/js/jquery.mjs.nestedSortable.js"></script>
	<script src="<?php echo FUrl; ?>/plugins/plg_chartjs/index.js"></script>
	<?php if(isset($_SESSION['PLATFORM'])) : ?>	
	<script src="<?php echo AdminPath; ?>/plugins/plg_ckeditor/ckeditor.js"></script>	
	<?php else : ?>
	<script src="<?php echo FUrl; ?>/plugins/plg_ckeditor/ckeditor.js"></script>	
        ...
        <div class="main">
            ...
            <div class="inner">
				...
				<div class="crumbs"> 
					...
					<span class="calendar"> 
						<?php  if(SiteLang == "id") : echo kalender(date("Y"), "l, d F Y"); ?>
						<?php  else : echo date("l, d F Y"); endif; ?>
					</span> 
				</div>
...
<script>$(function() {	CKEDITOR.replace( 'generator_editor', {toolbar : 'Null',}); });</script>
<div class="invisible" style="display:none"><textarea id="generator_editor"></textarea></div>
...
$('.gravatar[data-gravatar-hash]').each(function () {
	...
	$.ajax({
		url: '<?php echo $http;?>://gravatar.com/avatar/'+ hash +'/?size=32' ,
		type : 'GET',
		timeout: 5000, 
		error:function(data){
		...
		success: function(data){
			th.html('<img width="34" height="34" alt="" src="<?php echo $http;?>://gravatar.com/avatar/'+ hash +'/?size=34">');
		}
	});
});
});	
