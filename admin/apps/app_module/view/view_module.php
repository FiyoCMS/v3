	...
	<table class="data">
		...
		<tbody>
			...
			foreach($sql as $row){	
				...
				echo "<tr><td align='center'>$check</td><td>$name</td><td class='hidden-xs'><div class='switch-group'>$sname$status</div></td><td class='hidden-xs'>$row[position]</td><td>$row[folder]</td><td align='center' class='hidden-xs'>$row[short]</td><td align='center' class='hidden-xs'>$level</td></tr>";
				$no++;	
			}
			?>
        </tbody>			
