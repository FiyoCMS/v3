			...
			<table class="data2">				
				...
				<tr>
					...
					<div class="image-group <?php if(empty($qr['photo'])) echo "noimg"; ?>">
						...
						<label <?php if(empty($qr['photo'])) echo " style=' display: none';"; ?> class=" red tips deletes btn" data-placement="top" title="" data-original-title="<?php echo Delete; ?>"><span><b class="icon-remove-sign"></b></span></label>
					</div>					
					</td>
				</tr>		
			</table>
