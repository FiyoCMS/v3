	...
	<table class="data">
		<thead>
			<tr>								  
				...
				<th style="width:15% !important; text-align: center;" class=''>Total Contact(s)</th>
			</tr>
		</thead>
		<tbody>
			<?php
			...
			foreach($sql as $row){
				...
				$count = $db->query( $count)->fetchColumn();
				...
				echo "<tr>";
				echo "<td align='center'>$checkbox</td><td>$name</td><td>$row[group_desc]</td><td align='center'>$count</td>";
				echo "</tr>";
				$no++;	
			}
			?>
