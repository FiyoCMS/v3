...
$sql=DB::table(FDBPrefix.'setting')->where("name='site_theme'")->get(); 
$qr_themes = $sql[0]; 
...
<div id="app_header">
	<div class="warp_app_header">		
		...
		<div class="app_link">			
				...
				<div class="tooltip fade right in theme-count"><div class="tooltip-arrow"></div><div class="tooltip-inner count">0</div></div>
