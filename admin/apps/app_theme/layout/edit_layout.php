...
$sql = DB::table(FDBPrefix.'theme_layout')->where("id=$_REQUEST[id]")->get(); 
$row = $sql[0];
?>
...
<form method="post">
	<div id="app_header">
		<div class="warp_app_header">		
			...
			<div class="app_link">
                                <a class="btn btn-default" href="?app=theme&view=layout" title="<?php echo Cancel; ?>"><i class="icon-arrow-left"></i></a>
