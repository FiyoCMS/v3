...
<div class="app_link tabs">		
	<div class="app_link">		
		<a class="btn btn-default <?php echo $a; ?>" href="?app=theme&folder=<?php echo $folder;?>"><i class="icon-magic"></i> <?php echo Information; ?></a>
		<?php if(USER_LEVEL < 3 AND file_exists($params)) : ?>
		<a class="btn btn-default <?php echo $c; ?>" href="?app=theme&folder=<?php echo $folder;?>&type=param"><i class="icon-cogs"></i> Parameter</a>		
		<?php endif; ?>	
		<?php if(USER_LEVEL == 1) : ?>
		<a class="btn btn-default <?php echo $b; ?>" href="?app=theme&folder=<?php echo $folder;?>&type=files"><i class="icon-file-text-o"></i> Files</a>		
		<?php endif; ?>	
