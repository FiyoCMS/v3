		...
		<div>
			<table>
				<tr>
					...
					<button class="btn btn-primary upload" name="upload">Install</button></div></td>
				</tr>
				<tr>
					...
					<button class="btn btn-primary copy" name="copy">Install</button></div>
					</td>
				</tr>	
			</table>
		</div> 
		...
		<div>
			<table>
				<tr>
					...
					<td><b class="version-val"><?php echo siteConfig('version'); ?></b> <a type="button" value="Check Update" class="btn btn-success updater" href="#update">Check Update</a></td>
				</tr>
			</table>
		</div> 
    </div> 
