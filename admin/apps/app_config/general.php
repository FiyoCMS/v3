		...
		<div>
			<table>		
				...
				<tr>
					...
					<td><input type="text" name="site_title" size="30" value="<?php echo siteConfig('site_title'); ?>" required></td>
				</tr>
				<tr>
					...
					<input required type="text" name="site_url" size="40" value="<?php echo siteConfig('site_url'); ?>">
				 </div></td>
				</tr>	
				<tr>
					<td class="row-title"><span class="tips"  title="<?php echo Site_Mail_tip; ?>"><?php echo Site_Mail; ?></td>
					<td><input type="email" name="site_mail" size="30" value="<?php echo siteConfig('site_mail'); ?>" required></td>
				</tr>
				<tr>
					<td class="row-title"><span class="tips"  title="<?php echo Folder_AdminPanel_tip; ?>"><?php echo Folder_AdminPanel; ?></td>
					<td><input type="text" name="folder_new" size="15" value="<?php echo siteConfig('backend_folder'); ?>" required>
					<input type="hidden" name="folder_old" value="<?php echo siteConfig('backend_folder'); ?>"></td>
				</tr>
				<tr>
					...
					<td>
						...
						?>
						<p class="switch">
							<input id="radio1"  value="1" name="site_status" type="radio" <?php echo $s1;?> class="invisible">
							<input id="radio2"  value="0" name="site_status" type="radio" <?php echo $s0;?> class="invisible">
				...
				<tr>
					...
					<td><textarea rows="4" cols="30" name="site_keys" style="width:100%; resize: vertical;"><?php echo siteConfig('site_keys'); ?></textarea></td>
				</tr>
				<tr>
					<td class="row-title"><span class="tips"  title="<?php echo Meta_Description_tip; ?>"><?php echo Meta_Description; ?></td>
					<td>
					<textarea rows="6" cols="30" name="site_desc" style="width:100%; resize: vertical;"><?php echo siteConfig('site_desc'); ?></textarea></td>
				</tr>
			</table>
		</div>
	</div>
			...
			<table>		
				<tr>
					...
					<td>
						...
						?>
						<p class="switch">
							<input id="radio3"  value="1" name="sef_url" type="radio" <?php echo $u1;?> class="invisible">
							<input id="radio4"  value="0" name="sef_url" type="radio" <?php echo $u0;?> class="invisible">
				...
				<tr>
					...
					<td>
						...
						?>
						<p class="switch">
							<input id="radio7"  value="1" name="sef_www" type="radio" <?php echo $u1;?> class="invisible">
							<input id="radio8"  value="0" name="sef_www" type="radio" <?php echo $u0;?> class="invisible">
				...
				<tr>
					...
					<td>
						...
						$sql = Database::table(FDBPrefix.'user_group')
								->select('level, group_name')->where('level > 3')->get();
