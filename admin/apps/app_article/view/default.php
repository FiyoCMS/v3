...
function iniTable () {
	if ($.isFunction($.fn.dataTable)) {	
		...
		oTable = $('table.data').dataTable({
			"bProcessing": true,
			"bServerSide": true,
			"sAjaxSource": "?app=article&api=article-list&cat="+cat+"&user="+user+"&level="+level+"&token=<?php echo USER_TOKEN; ?>",
			"bJQueryUI": true,  
	...
	<div id="app_header">
		<div class="warp_app_header">				
			...
			<div class="app_link">			
				...
				<button type="submit" class="btn btn-danger" title="<?php echo Delete; ?>" value="<?php echo Delete; ?>" name="delete"><i class="icon-trash"></i> &nbsp;<?php echo Delete; ?></button>
