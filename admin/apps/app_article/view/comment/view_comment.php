...
$(function() {	
	...
	if ($.isFunction($.fn.dataTable)) {	
		...
		oTable = $('table.data').dataTable({
			"bProcessing": true,
			"bServerSide": true,
			"sAjaxSource": "?app=article&api=comment-list",
			"bJQueryUI": true,
			...
			"fnDrawCallback": function( oSettings ) {	
				...
				$(".activator label").click(function(){
					...
					$.ajax({
						url: "?app=article&api=comment-status",
						data: "stat="+value+"&id="+id,
						success: function(data){
							$('.type',parent).attr('value',value);					
							notice(data);		
						}
					});
				});
	...
	<div id="app_header">
		<div class="warp_app_header">		
		  ...
		  <div class="app_link">			
			...
			<button type="submit" class="delete btn btn-danger" title="<?php echo Delete; ?>" value="<?php echo Delete; ?>" name="delete_comment"><i class="icon-trash"></i> &nbsp;<?php echo Delete; ?></button>
