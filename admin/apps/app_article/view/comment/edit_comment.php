...
$qr = Database::table(FDBPrefix.'comment')->
...
<input value="<?php echo $qr['id'];?>" type="hidden" name="id">
	<div id="app_header">
		<div class="warp_app_header">		
			<div class="app_title">Edit Comment</div>			
			<div class="app_link">				
				<a class="btn btn-default" href="?app=article&view=comment" title="<?php echo Prev; ?>"><i class="icon-arrow-left"></i> <?php echo Prev; ?></a>
				
				<button type="submit" class="btn btn-success" title="<?php echo Save; ?>" value="<?php echo Save; ?>" name="save_comment"><i class="icon-check"></i> <?php echo Save; ?></button>			
				<?php printAlert(); ?>
		...
		<div>
			<table>					
				...
				<tr>
					...
					<td><input value="<?php echo $qr['website'];?>" type="text" name="website" size="25"  id="order"></td>
				</tr>
				<tr>
