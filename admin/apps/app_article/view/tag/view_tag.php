...
<form method="post" id="form">
	<div id="app_header">
		<div class="warp_app_header">		
		  ...
		  <div class="app_link">			
			<a class="add btn btn-primary" href="?app=article&view=tag&act=add"><i class="icon-plus"></i> <?php echo New_Tag; ?></a>
			<button type="submit" class="delete btn btn-danger" title="<?php echo Delete; ?>" value="<?php echo Delete; ?>" name="delete_tag"><i class="icon-trash"></i> &nbsp;<?php echo Delete; ?></button>
		  </div> 
		  <?php printAlert(); ?>		  
		</div>
	</div>
