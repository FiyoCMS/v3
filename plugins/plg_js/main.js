...
function loader() {
	...
	$('input[type="checkbox"]').wrap("<label>");
	$('input[type="radio"]').parent().wrap("<label>");
	...
	$('input[type=date], .datetime').attr('type','text').after('<span class="add-on input-group-addon"><i class="icon-calendar"></i></span>').parent().wrapInner("<div class='input-append date input-group'>").datetimepicker();
